...
import com.opensource.techblog.springmvc.portlet1.model.ProductClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "multiple-project-poc-child1-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "multiple-project-poc-child1";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.opensource.techblog.springmvc.portlet1.model.impl.ProductImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
            ...
            return new com.opensource.techblog.springmvc.portlet1.NoSuchProductException();
        }
